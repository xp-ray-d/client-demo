...
public class SplitBind {
    ...
    public static void main(String[] args) throws Exception {
        ...
        msgPrivate.putIfAbsent("name", "厦门快接网络科技有限公司");
        ...
        // 发送 http 请求
        final ApiRsp apiRsp = BaseApiInvokeService.invoke(clientConfig, "/txn/v2/alipay/split/bind", apiReqExt);
